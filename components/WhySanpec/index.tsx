...
import { ExternalLink, Zap, Award, TrendingUp, ChevronRight, Play, Pause, Home } from 'lucide-react';
...
export default function StrategicInnovation() {
  ...
  return (
    <div className="min-h-screen bg-gray-500">
      {/* Hero/Title Section - From Sidebar Code */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-4 rounded-xl text-white text-center shadow-lg transform hover:scale-105 transition-transform">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="space-y-4">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg border-l-4 border-gray-800 hover:shadow-xl transition-shadow">
                  <div className="flex items-start gap-4">
