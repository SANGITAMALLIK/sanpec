          ...
          >
            {currentData.map((item, index) => (
              <a
                ...
                className="relative flex-shrink-0 w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] h-[450px] sm:h-[500px] group cursor-pointer block"
                  ...
                  <div className="relative h-2/5 p-6 sm:p-8 flex flex-col justify-between bg-[#0a0e1a] group-hover:bg-[#CD091B] transition-all duration-500">
                    {activeTab === "projects" ? (
                      ...
                      <div className="flex flex-col gap-3">
                        <h3 
                          className="text-white font-bold text-base sm:text-lg leading-tight line-clamp-2"
                          dangerouslySetInnerHTML={{ __html: item.title }}
                        />
                        
                        {item.excerpt && (
                          <div 
                            className="text-white/80 group-hover:text-white/90 text-xs sm:text-sm leading-relaxed line-clamp-4"
