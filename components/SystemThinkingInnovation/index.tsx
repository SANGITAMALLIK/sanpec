...
const SystemThinkingInnovation: React.FC = () => {
  return (
...
<div className="group flex items-center gap-1 sm:gap-1.5 text-white/70 hover:text-white transition-colors duration-300">
            <span className="font-medium">Why SANPEC</span>
...
export default SystemThinkingInnovation;