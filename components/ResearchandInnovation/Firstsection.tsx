  ...
  const accordionData = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>You will tackle real-world challenges and gain knowledge about emerging trends, as you learn from our <a href="https://www.gonzaga.edu/school-of-engineering-applied-science/graduate/transmission-distribution/faculty" target="_blank" rel="noopener noreferrer" className="text-[#0B1931] font-semibold hover:text-[#1a2f4d] transition-colors">expert faculty</a>, who are working engineers and industry leaders at top utilities and engineering firms around the United States.</p>
          <p>We offer two online choices: a <strong><a href="https://www.gonzaga.edu/school-of-engineering-applied-science/graduate/transmission-distribution/masters" target="_blank" rel="noopener noreferrer" className="text-[#0B1931] hover:text-[#1a2f4d] transition-colors">Master of Engineering in Transmission and Distribution Engineering</a></strong> and a <strong><a href="https://www.gonzaga.edu/school-of-engineering-applied-science/graduate/transmission-distribution/certificate" target="_blank" rel="noopener noreferrer" className="text-[#0B1931] hover:text-[#1a2f4d] transition-colors">Certificate in Transmission and Distribution Engineering</a></strong>.</p>
