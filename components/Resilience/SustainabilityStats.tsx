...
export default function HolisticImpactSection() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-gray-50 to-slate-100 py-20 px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-6xl font-bold leading-tight">
                <span className="bg-gradient-to-r from-[#101631] to-[#101631]/80 bg-clip-text text-transparent">
                  Impact &
                </span>
              </h2>
              <h2 className="text-6xl font-bold italic leading-tight">
                <span className="bg-gradient-to-r from-[#CD091B] to-[#CD091B]/80 bg-clip-text text-transparent">
                  Sustainability
                </span>
              </h2>
            </div>
            ...
            <div className="border-l-4 border-[#101631] bg-white rounded-r-2xl p-8 shadow-lg">
          ...
          <div className="relative w-full h-[600px]">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 text-center">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl px-8 py-6 shadow-2xl border-4 border-gray-200">
                ...
                <h3 className="text-4xl font-black bg-gradient-to-r from-[#101631] to-[#CD091B] bg-clip-text text-transparent">IMPACT</h3>
              </div>
            </div>
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 600 600">
              <defs>
                <linearGradient id="lineGrad1" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" style={{stopColor: '#101631', stopOpacity: 0.5}} />
                  <stop offset="100%" style={{stopColor: '#101631', stopOpacity: 0.3}} />
                </linearGradient>
                <linearGradient id="lineGrad2" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" style={{stopColor: '#CD091B', stopOpacity: 0.5}} />
                  <stop offset="100%" style={{stopColor: '#CD091B', stopOpacity: 0.3}} />
                </linearGradient>
                <linearGradient id="lineGrad3" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" style={{stopColor: '#CD091B', stopOpacity: 0.4}} />
                  <stop offset="100%" style={{stopColor: '#101631', stopOpacity: 0.4}} />
                </linearGradient>
              </defs>
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10">
              ...
              >
                <div className={`w-40 h-40 rounded-full bg-gradient-to-br ${nodes[0].color} p-1.5 shadow-xl transform transition-all duration-500 ${activeNode === 1 ? 'scale-110 shadow-[#101631]/60' : 'scale-100'}`}>
            ...
            <div className="absolute bottom-0 left-16 z-10">
              <div 
                ...
                onMouseLeave={() => setActiveNode(null)}
              >
                <div className={`w-40 h-40 rounded-full bg-gradient-to-br ${nodes[1].color} p-1.5 shadow-xl transform transition-all duration-500 ${activeNode === 2 ? 'scale-110 shadow-[#CD091B]/60' : 'scale-100'}`}>
                  <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden p-3">
            ...
            <div className="absolute bottom-0 right-16 z-10">
              <div 
                ...
                onMouseLeave={() => setActiveNode(null)}
              >
                <div className={`w-40 h-40 rounded-full bg-gradient-to-br ${nodes[2].color} p-1.5 shadow-xl transform transition-all duration-500 ${activeNode === 3 ? 'scale-110 shadow-[#CD091B]/60' : 'scale-100'}`}>
                  <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden p-3">
